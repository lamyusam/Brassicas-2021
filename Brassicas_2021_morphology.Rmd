...
```{r modeltesting-poisson-brassica, fig.show="hold", results='asis'}
...
```{r modeltesting-inverse-brassica, fig.show="hold", results='asis}
...
```{r modeltesting-gamma-brassica, fig.show="hold", results='asis}
model.gauss = glmer(get(response.var)~Environment + Wild_Dom + Environment:Wild_Dom + (1|Population), 
                     data=phenodata.gen2.clean.brass.omit, 
