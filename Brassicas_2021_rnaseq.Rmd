...
foo = subset(brass.intplotdata, gene=="gene-LOC103873136")

bar = foo %>% group_by(domesticated,treatment) %>% 
  summarise(mean = mean(count))
  
wild_higher = abs(diff(subset(bar,domesticated == "Wild")$mean)) > abs(diff(subset(bar,domesticated == "Cultivated")$mean))
