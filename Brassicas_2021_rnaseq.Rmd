...
First, let's run the model and check that the fit looks good:
...
brass.output
write.csv(brass.output, file = "Analysis/RNAseq/Tables/deseq_domesticate_vs_progenitor_summary.csv")
```
