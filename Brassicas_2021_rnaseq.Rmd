...
#re-run above chunk, but subset intgene.data to use only accession from one domesticate at a time
#for each domesticate, generate values and p-values and stick them into a table
